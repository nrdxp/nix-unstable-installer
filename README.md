...
* Release: `nix-2.23.0pre20240524_c90a763`
...
```sh
sh <(curl -L https://github.com/numtide/nix-unstable-installer/releases/download/nix-2.23.0pre20240524_c90a763/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v16
      with:
        install_url: https://github.com/numtide/nix-unstable-installer/releases/download/nix-2.23.0pre20240524_c90a763/install
