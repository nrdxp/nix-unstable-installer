...
* Release: `nix-2.23.0pre20240509_de8c3c0`
...
```sh
sh <(curl -L https://github.com/numtide/nix-unstable-installer/releases/download/nix-2.23.0pre20240509_de8c3c0/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v16
      with:
        install_url: https://github.com/numtide/nix-unstable-installer/releases/download/nix-2.23.0pre20240509_de8c3c0/install
